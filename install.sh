...
function autoConfigureKathraCli() {
    ...
    writeEntryIntoFile "RESOURCE_MANAGER_HOST" "pipelinemanager.$BASE_DOMAIN" "${LOCAL_CONF_FILE_KATHRA_CLI}"
    writeEntryIntoFile "PIPELINE_MANAGER_HOST" "resourcemanager.$BASE_DOMAIN" "${LOCAL_CONF_FILE_KATHRA_CLI}"
