...
external_url {{ .Values.externalUrl | squote }}
...
### Email Settings
gitlab_rails['gitlab_email_enabled'] = {{ .Values.smtp.enabled }}
gitlab_rails['gitlab_email_from'] = {{ .Values.smtp.username | squote }} 
# gitlab_rails['gitlab_email_display_name'] = 'Example'
gitlab_rails['gitlab_email_reply_to'] = {{ .Values.smtp.username | squote }}
...
gitlab_rails['LDAP_ENABLED'] = {{ .Values.ldap.enabled }}
{{- if .Values.ldap.enabled }}
gitlab_rails['ldap_servers'] = YAML.load <<-'EOS'
{{ include "ldap.cfg" . | indent 2 }}
  EOS
{{- end }}
...
### OmniAuth Settings
###! Docs: https://docs.gitlab.com/ce/integration/omniauth.html
gitlab_rails['omniauth_enabled'] = {{ .Values.oidc.omniauthEnabled }}
gitlab_rails['omniauth_allow_single_sign_on'] = [{{ .Values.oidc.omniauthAllowSingleSignOn | quote }}]
gitlab_rails['omniauth_block_auto_created_users'] = {{ .Values.oidc.omniauthBlockAutoCreatedUsers }}
gitlab_rails['omniauth_auto_sign_in_with_provider'] = {{ .Values.oidc.omniauthAutoSignInWithProvider | quote }}
gitlab_rails['omniauth_providers'] = [
{{ include "omniauth.cfg" . | indent 2 }}
] 
### Backup Settings
...
gitlab_rails['gitlab_shell_ssh_port'] = {{ .Values.configuration.ssh.containerPort }}
...
gitlab_rails['smtp_enable'] = {{ .Values.smtp.enabled }} 
gitlab_rails['smtp_address'] = {{ .Values.smtp.address | squote }}
gitlab_rails['smtp_port'] = {{ .Values.smtp.port }}
gitlab_rails['smtp_user_name'] = {{ .Values.smtp.username | squote }}
gitlab_rails['smtp_password'] = {{ .Values.smtp.password | squote }}
gitlab_rails['smtp_domain'] = {{ .Values.smtp.domain | squote }}
gitlab_rails['smtp_authentication'] = {{ .Values.smtp.authentication | squote }}
gitlab_rails['smtp_enable_starttls_auto'] = {{ .Values.smtp.enableStartTlsAuto }}
gitlab_rails['smtp_openssl_verify_mode'] = {{ .Values.smtp.opensslVerifyMode | squote }}
...
################################################################################
nginx['listen_port'] = {{ .Values.nginx.port }}
nginx['listen_https'] = {{ .Values.nginx.listenHttps }}
nginx['proxy_set_headers'] = {{ .Values.nginx.setHeaders }}
# nginx['enable'] = true
...
prometheus['enable'] = {{ .Values.configuration.prometheusState }}
